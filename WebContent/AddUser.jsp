...
<body>
	...
	<form ng-controller="userController" ng-submit="addUser()">

		User Name : <input type="text" name="name" ng-model="userName"><br>
		<br> Phone : <input type="text" name="phone" ng-model="phone"><br>
		<br> Country : <select name="country" id="country"
			ng-model="country">
